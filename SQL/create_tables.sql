...
CREATE TABLE GroundSupport (
    ...
    UsageDuration INT NOT NULL,  -- Duration of equipment usage in minutes
...
CREATE TABLE Maintenance (
    ...
    MaintenanceDuration INT NOT NULL,  -- Duration of maintenance
...
CREATE TABLE FlightBooking (
    ...
    PassengerID INT NOT NULL,  -- Reference to the associated passenger
    TicketNumber AS ('TNO-' + RIGHT('00000' + CAST(TicketID AS VARCHAR), 5)) PERSISTED UNIQUE,  -- Computed ticket number in format TNO-00001, TNO-00002, etc.
